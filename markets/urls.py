...
urlpatterns = [
    ...
    path('favoriteitem/<int:group_id>', FavoriteItemView.as_view()), #찜 목록 아이템 (post, get 용도)
    path('favoriteitem/<int:group_id>/<int:item_id>', FavoriteItemView.as_view()), #찜 목록 아이템 (delete 용도)
]